...
# 3.5 - 8
from datetime import date, time, datetime, timedelta
curr_date = datetime.strptime(input(), "%d.%m.%Y %H:%M") - datetime.min
...
def func():
    ds = {0: ('дней', 'часов', 'минут'),
          1: ('день', 'час', 'минута'),
          2: ('дня', 'часа', 'минуты'),
          3: 'дня', 4: 'дня', 5: 'дней', 6: 'дней', 7: 'дней', 8: 'дней', 9: 'дней'}
    hs = {0: 'часов', 1: 'час', 2: 'часа', 3: 'часа', 4: 'часа', 5: 'часов', 6: 'часов', 7: 'часов', 8: 'часов', 9: 'часов'}
    ms = {0: 'минут', 1: 'минута', 2: 'минуты', 3: 'минуты', 4: 'минуты', 5: 'минут', 6: 'минут', 7: 'минут',
          8: 'минут', 9: 'минут'}
